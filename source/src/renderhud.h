...
void drawcrosshair(playerent *p, int n, struct color *c = NULL, float size = -1.0f);
...
void show_out_of_renderloop_progress(float bar1, const char *text1, float bar2 = 0, const char *text2 = NULL);
