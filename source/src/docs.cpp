...
static void adddocargument(char *token, char *desc, char *values, char *vararg)
{
...
static char *cvecstr(vector<char *> &cvec, const char *substr, int *rline = NULL)
{
    char *r = NULL;
...
static void docwriteref(int allidents, const char *ref, const char *schemalocation, const char *transformation)
{
...
static void docwritebaseref(char *ref, char *schemalocation, char *transformation)
{
